...
class AddFoundationalDetail extends StatefulWidget {
  ...
  @override
  _AddFoundationalDetailState createState() => _AddFoundationalDetailState(index);
}
...
class _AddFoundationalDetailState extends State<AddFoundationalDetail> {
  ...
  void initState() {
    ...
    if (index != null) {
      ...
      goalTextController = TextEditingController(text:foundationContent[index].goal);
      coreCompetenceTextController = TextEditingController(text: foundationContent[index].coreCompetence);
      coreCulturalAspectTextController = TextEditingController(text: foundationContent[index].coreCulturalAspect);
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  TextFieldWidget(
                    ...
                    textCollecter: Asa,
                    helperText: 'Pleasure ensure that the appropiate type is selected before entering the description',
