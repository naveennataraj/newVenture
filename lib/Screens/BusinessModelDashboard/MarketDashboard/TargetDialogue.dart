...
class CustomerTargetDialogue extends StatefulWidget {
  final String Asa;
  final String IwantTo;
  final String SothatIcan;

  const CustomerTargetDialogue({this.Asa, this.IwantTo, this.SothatIcan});
  @override
  _CustomerTargetDialogueState createState() => _CustomerTargetDialogueState();
}

class _CustomerTargetDialogueState extends State<CustomerTargetDialogue> {
  UserStory(int index) {
    String A = widget.Asa;
        ...
        child: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text(
                  "What we learnt about our customer",
                  ...
                  child: Padding(
                    ...
                    child: Hero(
                      ...
                      child: DashboardCards(
                        ...
                        cardTitle: 'What we learnt about our customer',
                        cardNote:
                      ...
                      SaveButton(
                        onTap: () {
                          _firestore
                              ...
                              .document(userStoriesContent[0].ID)
                              .updateData({
                            'Asa': AsaTextController.text,
