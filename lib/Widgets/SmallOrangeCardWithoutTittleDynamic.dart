...
class SmallOrangeCardWithoutTitleDynamic extends StatefulWidget {
  ...
  SmallOrangeCardWithoutTitleDynamic(
      {this.index, this.description, this.removingat, this.Dialogue});

  @override
  _SmallOrangeCardWithoutTitleDynamicState createState() =>
      _SmallOrangeCardWithoutTitleDynamicState(
          index, description, removingat, Dialogue);
}

class _SmallOrangeCardWithoutTitleDynamicState
    extends State<SmallOrangeCardWithoutTitleDynamic> {
  int index;
  String description;
  List removingat;
  Widget Dialogue;
